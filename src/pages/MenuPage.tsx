...
const MenuPage = () => {
  ...
  const menuItems: MenuItem[] = [
    // Хлеб и булочки
    {
      ...
      price: 80,
      image: '/img/4293fed7-a7f6-491f-bf19-127d0a3df8b5.jpg',
      category: 'bread',
      rating: 4.7,
      allergens: ['глютен']
    },
    {
      ...
      price: 65,
      image: '/img/7f2d9681-96dd-4e24-8dc4-cd76675f3a47.jpg',
      category: 'bread',
      rating: 4.5,
      allergens: ['глютен']
    },
    {
      ...
      price: 45,
      image: '/img/539a6304-28c9-43c5-a5e1-666ebb4e23ee.jpg',
      category: 'bread',
      rating: 4.3,
    ...
    // Торты
    {
      ...
      price: 1200,
      image: '/img/4323d6cb-dd79-4317-99cf-2e1127f2be21.jpg',
      category: 'cakes',
      rating: 4.9,
      isPopular: true,
    ...
    },
    {
      ...
      price: 980,
      image: '/img/d6dfbbe4-7aec-4344-b1ab-dca9a032d502.jpg',
      category: 'cakes',
      rating: 4.8,
    ...
    },
    {
      ...
      price: 1400,
      image: '/img/52a18754-beac-43ba-9751-3e60516d7abd.jpg',
      category: 'cakes',
      rating: 4.6,
      isNew: true,
      allergens: ['глютен', 'яйца', 'молоко']
    ...
    // Круассаны
    {
      ...
      price: 90,
      image: '/img/a9480b64-9f41-4a41-acbd-fd8cb9d4ae99.jpg',
      category: 'croissants',
      rating: 4.4,
    ...
    },
    {
      ...
      price: 120,
      image: '/img/778d91e1-52b6-4342-a11c-693269ceb899.jpg',
      category: 'croissants',
      rating: 4.8,
      isPopular: true,
      allergens: ['глютен', 'молоко']
    },
    {
      ...
      price: 140,
      image: '/img/e7988397-87a2-4920-ad32-253facdace18.jpg',
      category: 'croissants',
      rating: 4.7,
    ...
    // Пирожные
    {
      ...
      price: 95,
      image: '/img/7bc25400-d679-4521-8443-09906f83ac0f.jpg',
      category: 'pastries',
      rating: 4.6,
      allergens: ['глютен', 'яйца', 'молоко']
    },
    {
      ...
      price: 75,
      image: '/img/e94747d4-8ac2-4988-a818-898307e65c00.jpg',
      category: 'pastries',
      rating: 4.5,
      allergens: ['глютен', 'яйца', 'молоко']
    },
    {
      ...
      price: 180,
      image: '/img/c45e1d75-cf39-4d2a-b306-998df9a2ac84.jpg',
      category: 'pastries',
      rating: 4.9,
      isNew: true,
      allergens: ['глютен', 'яйца', 'молоко']
    ...
    // Печенье
    {
      ...
      price: 35,
      image: '/img/6e3e6b1d-071f-4b87-8bc5-ef10a955e242.jpg',
      category: 'cookies',
      rating: 4.2,
      allergens: ['глютен', 'молоко']
    },
    {
      ...
      price: 250,
      image: '/img/94834254-411e-477a-aa68-4bc8e464c267.jpg',
      category: 'cookies',
      rating: 4.8,
      isPopular: true,
    ...
    },
    {
      ...
      price: 40,
      image: '/img/3f84f43e-8b30-4504-a917-3a193e224262.jpg',
      category: 'cookies',
      rating: 4.4,
      allergens: ['глютен', 'яйца', 'молоко']
    },
    ...
    // Пироги
    {
      ...
      price: 350,
      image: '/img/cd78188a-e22f-4680-ac65-38f94fbd1da0.jpg',
      category: 'pies',
      rating: 4.7,
      allergens: ['глютен', 'яйца', 'молоко']
    },
    {
      ...
      price: 420,
      image: '/img/965ff0ce-5630-4680-ab03-a0a02a63ce42.jpg',
      category: 'pies',
      rating: 4.6,
      allergens: ['глютен', 'яйца', 'молоко']
    }
